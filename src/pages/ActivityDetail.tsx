...
const ActivityDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[75vh] flex items-end overflow-hidden">
        ...
        <Link to="/" className="absolute top-4 left-4 sm:top-6 sm:left-6 md:top-8 md:left-8 z-20 animate-fade-in-up">
          <Button
            variant="hero"
            size="lg"
        ...
        <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 pb-12 sm:pb-16 md:pb-20 pt-24 sm:pt-32 md:pt-40">
          <div className="container max-w-6xl">
            <div className="animate-fade-in-up" style={{ animationDelay: "0.2s", animationFillMode: "backwards" }}>
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-white mb-4 sm:mb-6 md:mb-8 tracking-tighter leading-[1.1] sm:leading-[0.95] drop-shadow-2xl">
                {activity.title}
              </h1>
            </div>
            <div className="animate-fade-in-up" style={{ animationDelay: "0.4s", animationFillMode: "backwards" }}>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white/95 max-w-4xl leading-relaxed font-light tracking-wide drop-shadow-lg">
        ...
        {/* Bottom Fade */}
        <div className="absolute bottom-0 left-0 right-0 h-24 sm:h-32 bg-gradient-to-t from-background to-transparent z-[5]" />
      </section>
      ...
      <section className="py-8 sm:py-12 md:py-16 lg:py-20 border-b border-border/50 bg-gradient-to-b from-card to-background relative overflow-hidden">
        ...
        <div className="container max-w-6xl px-4 sm:px-6 md:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-10 md:mb-12 sm:divide-x divide-border">
            {/* Status */}
            <div className="flex flex-col items-center text-center px-4 sm:px-6 animate-fade-in-up" style={{ animationDelay: "0.1s", animationFillMode: "backwards" }}>
            ...
            {/* Date */}
            <div className="flex flex-col items-center text-center px-4 sm:px-6 animate-fade-in-up" style={{ animationDelay: "0.2s", animationFillMode: "backwards" }}>
              <div className="text-xs font-extrabold text-muted-foreground uppercase tracking-widest mb-3 sm:mb-4 opacity-70">
                Date
              </div>
          ...
          <div className="flex flex-col items-center text-center animate-fade-in-up" style={{ animationDelay: "0.3s", animationFillMode: "backwards" }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 w-full max-w-4xl">
              {activity.metrics?.map((metric, index) => {
                ...
                return (
                  <div key={index} className="group relative flex flex-col items-center gap-2 sm:gap-3 text-foreground bg-gradient-to-br from-primary/5 via-background to-primary/5 px-6 sm:px-8 py-5 sm:py-6 rounded-2xl border-2 border-border/50 hover:border-primary/40 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                    ...
                    {/* Value */}
                    <span className="relative z-10 text-2xl sm:text-3xl font-extrabold text-foreground tracking-tight">{metric.value}</span>

                    {/* Label */}
                    <span className="relative z-10 text-xs font-bold text-muted-foreground uppercase tracking-widest text-center">{metric.label}</span>
                  </div>
                );
              })}
            </div>
